...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/shop/admin">网站后台</a>
            <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
            <nav class="nav navbar-nav">
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onclick="article_add('添加分类','<?php echo url('category/add'); ?>')"><i class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/article'); ?>" data-title="文章列表">文章列表</a></li>
                    <li><a data-href="<?php echo url('admin/article_category'); ?>" data-title="文章分类">文章分类</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/picture'); ?>" data-title="图片管理" href="javascript:void(0)">图片管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/reply'); ?>" data-title="评论列表" href="javascript:void(0)">评论列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            <dt><i class="Hui-iconfont">&#xe62d;</i> van♂友管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="<?php echo url('admin/link'); ?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-tongji">
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="<?php echo url('admin/welcome'); ?>"></iframe>
    </div>
</div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/static/extend/H-ui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
