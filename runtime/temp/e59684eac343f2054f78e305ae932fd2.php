...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加文章" data-href="" onclick="article_add('添加文章','<?php echo url('admin/article_edit'); ?>','100%','100%');" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('<?php echo $vo['article_title']; ?>','article&id=<?php echo $vo['id']; ?>','100%','100%')" title="<?php echo $vo['article_title']; ?>"><?php echo $vo['article_title']; ?></u></td>
					<td><?php echo $vo['name']; ?></td>
					<td>
						<?php switch($vo['source']): case "1": ?>转载<?php break; default: ?>原创
						<?php endswitch; ?>
					</td>
					<td><?php echo date("Y-m-d H:i:s",$vo['create_time']); ?></td>
					<td><?php echo $vo['hits']; ?></td>
					<td class="td-status">
						<?php switch($vo['status']): case "1": ?><span class="label label-success radius">已发布</span><?php break; default: ?><span class="label label-defaunt radius">未发布</span>
						<?php endswitch; ?>
					</td>
					<td class="f-14 td-manage">
						<?php switch($vo['status']): case "1": ?><a style="text-decoration:none" onClick="article_stop(this,<?php echo $vo['id']; ?>)" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a><?php break; default: ?> <a style="text-decoration:none" onClick="article_start(this,<?php echo $vo['id']; ?>)" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a>
						<?php endswitch; ?>
						
						<a style="text-decoration:none" class="ml-5" onClick="article_edit('编辑','article_edit&id=<?php echo $vo['id']; ?>&action=edit','100%','100%')" href="javascript:;" title="编辑">
