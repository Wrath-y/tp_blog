<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"E:\phpStudy\WWW\blog\public/../application/index\view\index\index.html";i:1515774467;s:61:"E:\phpStudy\WWW\blog\application\index\view\index\footer.html";i:1515774055;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<header class="head-box carousel-inner">
    <div class="bg-img" onmouseover="set_height()" style="background: url(/static/picture/bg-img.jpg);background-repeat: no-repeat;background-attachment: fixed;background-size:100% auto;">
    </div>
...
<div class="container">
    <div class="row" style="margin-bottom: 40px">
        <div class="col-lg-8 col-lg-offset-2">
            <h3 class="col-lg-12 text-center"><a href="" style="color: #999999">这个世界由本王承担</a></h3>
            <div class="col-lg-12 text-center panel-group">
                <span class="fa fa-heart-o"> 发表于 2017/12/12 </span>
